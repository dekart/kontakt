module Kontakt
# This rack middleware converts POST requests from Vkontakte to GET requests.
...
# in the application.
  ...
  class Middleware
    ...
    def call(env)
      ...
      if (request.POST['sid'] || request.POST['signed_params']) && request.post? && request.params['_method'].blank?
